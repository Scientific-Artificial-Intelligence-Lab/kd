...
def python_execute(traversal, u, x):
    """
    evaulate the preorder traversal with provided data based on numpy. Modified from dso.
    """
    apply_stack = []
    dim_flag = None
    i = 0
...
def python_execute_torch(traversal, u, x):
    """
    Evaulate the preorder traversal with provided data based on torch. Modified from dso.
    """
    apply_stack = []
    dim_flag = None
    i=0
