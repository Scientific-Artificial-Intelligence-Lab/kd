"""  torch version of intermediate states management during the PDE tree constructions"""
...
class GrammarStateManager(StateManager):
    
    def __init__(self, embedding= True, embedding_size = 8):
