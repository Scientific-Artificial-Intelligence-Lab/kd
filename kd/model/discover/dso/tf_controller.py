...
from discover.dso.memory import Batch
from discover.program import Program
from discover.dso.prior import LengthConstraint
from discover.attention import AttentionCellWrapper as ACW
...
class Controller(object):
    ...
    prior : discover.prior.JointPrior
        JointPrior object used to adjust probabilities during sampling.

    state_manager: discover.tf_state_manager.StateManager
