...
from discover.program import Program, from_tokens,from_str_tokens
from discover.utils import empirical_entropy, get_duration, weighted_quantile, draw_criterion, filter_same,criterion
from discover.ga_utils import drop_duplicates
from discover.dso.memory import Batch, make_queue
from discover.dso.variance import quantile_variance
from discover.dso.train_stats import StatsLogger
