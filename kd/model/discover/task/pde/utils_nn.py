...
from .utils_noise import normalize, unnormalize, np2tensor,tensor2np
from .data_load import load_data, load_data_2D
from .utils_v1 import Diff, Diff2, Diff3
...
def load_noise_data(dataset, noise_level, data_ratio,  use_meta_data=False):
    ...
    data_path = f'./discover/task/pde/noise_data_new/{dataset}_noise={noise_level}_data_ratio={data_ratio}.npz'
...
if __name__ == '__main__':
    from discover.task.pde.data_load import  load_data
    import math
