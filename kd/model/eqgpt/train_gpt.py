...
# from process_dataset_wave_breaking import *  # only needed for raw .mat → .pkl conversion
...
def train(model, data_loader,Equation_name,epochs=100):
    ...
    for epoch in range(epochs):
        ...
        torch.save(model.state_dict(), str(_DIR / f'gpt_model/PDEGPT_{Equation_name}.pt'))
